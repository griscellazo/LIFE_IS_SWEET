...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.toolbar != null) {
            ...
            drawerToggle.setHomeAsUpIndicator(R.drawable.icon_hamburguer);
    ...
    public void goToMyBakery(View view) {
        Intent intent = new Intent(this, BakeryRecyclerActivity.class);
        startActivity(intent);
    }

    public void goToMyFavoriteBakerys(View view) {
        Intent intent = new Intent(this, BakeryListActivity.class);
        startActivity(intent);
    }
}